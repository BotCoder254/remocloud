...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left side - Image */}
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary-light to-accent-light relative overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-white">
            ...
            >
              Modern cloud file storage for developers
            </motion.p>
          </div>
        </div>
      </div>
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-text-secondary-light dark:text-text-secondary-dark">
              Access your cloud storage dashboard
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            {error && (
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                className="p-4 bg-danger-light bg-opacity-10 border border-danger-light rounded-lg text-danger-light text-sm"
              >
                {error}
              </motion.div>
            )}
