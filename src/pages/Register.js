...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left side - Image */}
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-accent-light to-secondary-light relative overflow-hidden">
        <div className="absolute inset-0 bg-black bg-opacity-20" />
        <img
          src="https://images.unsplash.com/photo-1558494949-ef010cbdcc31?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80"
          alt="Digital cloud infrastructure"
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-white">
            ...
            >
              Start building with our cloud storage platform
            </motion.p>
          </div>
        </div>
      </div>
